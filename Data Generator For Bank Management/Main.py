...
def update_customer(cursor):
    print("\n-- Update Customer Info --")
    ALLOWED_FIELDS = ['First_Name', 'Last_Name', 'Name', 'Street_Number', 'Street_Name',
                      'Unit', 'City', 'State', 'Zip_Code', 'Email_Id', 'Address']
    ...
    if field not in ALLOWED_FIELDS:
        print(f"Invalid field. Allowed fields are: {', '.join(ALLOWED_FIELDS)}")
        return
...
def main_menu():
    ...
    print("5. Filter Customers (Advanced)")
